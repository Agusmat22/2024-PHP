...
class Auto{
    ...
    public function __construct($marca, $color, $precio=0, $fecha="00-00-0000"){
    ...
    public function equals($auto){
        ...
        return get_class($this) === get_class($auto) && $this->getMarca() === $auto->getMarca();
    
    } 

    public static function add($auto1, $auto2)
    {
        if ($auto1->getMarca() == $auto1->getMarca() && $auto1->getColor() == $auto2->getColor()) {
